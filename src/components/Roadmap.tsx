  ...
  const milestones = [
    {
      phase: "Phase 1 (Live)",
      title: "MVP Launch",
      items: ["Telegram Bot Interface", "Bybit API Connector", "Rule-Based Validation Engine", "Real-time Outcome Logging"],
      status: "completed",
      color: "bg-[#00B894]"
    },
    {
      ...
      items: ["Binance API Connector", "OKX API Integration", "Data Feed Catalog", "Advanced Activity Logging"],
      status: "in-progress",
      color: "bg-[#004859]"
    },
    {
